...
SQLALCHEMY_DATABASE_USER = os.getenv('SECURITY_MONKEY_SQLALCHEMY_DATABASE_USER', 'securitymonkeyuser')
SQLALCHEMY_DATABASE_PASSWORD = os.getenv('SECURITY_MONKEY_SQLALCHEMY_DATABASE_PASSWORD', 'securitymonkeypassword')
SQLALCHEMY_DATABASE_HOSTNAME = os.getenv('SECURITY_MONKEY_SQLALCHEMY_DATABASE_HOSTNAME', 'localhost')
SQLALCHEMY_DATABASE_PORT = os.getenv('SECURITY_MONKEY_SQLALCHEMY_DATABASE_PORT', '5432')
SQLALCHEMY_DATABASE_DBNAME = os.getenv('SECURITY_MONKEY_SQLALCHEMY_DATABASE_DBNAME', 'secmonkey')
SQLALCHEMY_DATABASE_URI = 'postgresql://{}:{}@{}:{}/{}'.format(SQLALCHEMY_DATABASE_USER, SQLALCHEMY_DATABASE_PASSWORD,
                                                               SQLALCHEMY_DATABASE_HOSTNAME, SQLALCHEMY_DATABASE_PORT,
...
MAIL_DEFAULT_SENDER = os.getenv('SECURITY_MONKEY_MAIL_DEFAULT_SENDER', 'securitymonkey@example.com')
...
WTF_CSRF_ENABLED = env_to_bool(os.getenv('SECURITY_MONKEY_SM_WTF_CSRF_ENABLED', True))
WTF_CSRF_SSL_STRICT = env_to_bool(os.getenv('SECURITY_MONKEY_SM_WTF_CSRF_SSL_STRICT', True))  # Checks Referer Header. Set to False for API access.
...
GOOGLE_DEFAULT_ROLE = os.getenv('SECURITY_MONKEY_GOOGLE_DEFAULT_ROLE', 'View')
# Details about domain-wide-delegation https://developers.google.com/admin-sdk/directory/v1/guides/delegation
GOOGLE_DOMAIN_WIDE_DELEGATION_KEY_PATH = os.getenv('SECURITY_MONKEY_GOOGLE_DOMAIN_WIDE_DELEGATION_KEY_PAT', '')  # path to service account key with enabled domain wide delegation
GOOGLE_ADMIN_ROLE_GROUP_NAME = os.getenv('SECURITY_MONKEY_GOOGLE_ADMIN_ROLE_GROUP_NAME', '')  # Google group name which should map to security-monkey role Admin
GOOGLE_AUTH_API_METHOD = os.getenv('SECURITY_MONKEY_GOOGLE_AUTH_API_METHOD', 'People')  # alternative 'Directory' to use Google SSO against Directory API
GOOGLE_DOMAIN_WIDE_DELEGATION_SUBJECT = os.getenv('SECURITY_MONKEY_GOOGLE_DOMAIN_WIDE_DELEGATION_SUBJECT', '')  # perform google directory api calls as the this subject
...
SESSION_COOKIE_SECURE=env_to_bool(os.getenv('SECURITY_MONKEY_SESSION_COOKIE_SECURE', True))
